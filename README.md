...
Fill in the `router.rb` and `app.rb` files to implement this. **No need to instanciate the router with a controller** as we don't have it yet. Just print `TODO` for the moment when the user selects a task.
